...
<div class="row">
	...
	<aside class="col-md-4 col-md-offset-1 single-actores-rel">
		<div class="row actor-rel">
			<figure class="col-md-4"><img class="img-responsive" src="images/actores-01.png" alt="Miguel Ángel Mendo" /></figure>
			<div class="col-md-8">Miguel Ángel Mendo<br />Actor</div>
		</div>
		<div class="row actor-rel">
			<figure class="col-md-4"><img class="img-responsive" src="images/actores-01.png" alt="Miguel Ángel Mendo" /></figure>
			<div class="col-md-8">Miguel Ángel Mendo<br />Actor</div>
