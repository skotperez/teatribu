...
<section id="directors" class="row sec">
	...
	<div class="col-sm-12">
		...
		<article class="director">
			<header><h2 class="director-tit">Irina Kouberskaya</h2></header>
			...
			<ul class="list-unstyled director-extra">
				...
				<li><a href="">+ Enalces</a></li>
			</ul>
			<div class="row director-gallery">
				<figure class="col-md-2"><img class="img-responsive" src="images/programacion.img.01.png" alt="Image alternative text" /></figure>
				<figure class="col-md-2"><img class="img-responsive" src="images/programacion.img.02.png" alt="Image alternative text" /></figure>
				<figure class="col-md-2"><img class="img-responsive" src="images/programacion.img.03.png" alt="Image alternative text" /></figure>
			</div>
		</article>
		<article class="director">
