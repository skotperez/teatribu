...
<div class="row text-right text-up"><div id="main-tit" class="col-sm-12">Programación <span class="vivo">Temporada 2014</span></div></div>
	<article class="single row">
		<figure class="col-sm-12"><img class="img-responsive" src="images/home.img.01.png" /></figure>
		<div class="col-sm-12"><div class="single-text">
			<div class="single-data pull-right">
				<div class="single-date"><span class="text-up">Del 24 de abril al 22 de junio</span><br />Sábados y domingos 19h</div>
		...
		<div class="col-sm-8 single-content">
			...
			<h2>Género y duración</h2>
			<p>Drama. 2:30 horas con descanso de 15 minutos</p>
			<h2>Reparto</h2>
			<p>Mª Luisa Gª Budí (Madre) , Miguel Pérez-Muñoz (Novio), Matilde Juárez/Nereida San Martín
			(Novia), José Luis Sanz (Padre), Alejandra Navarro/Chelo Vivares (Criada),
			David García (Leonardo), Irene Polo (Mujer de Leonardo), María Barrionuevo (Suegra), Inma
			...
			<p class="quote">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam dignissim sed nisi ut imperdiet. Vestibulum eu quam nulla. Phasellus turpis leo, pharetra vel augue in, hendrerit facilisis eros. Fusce vehicula lectus nec dui vestibulum consectetur. Suspendisse sit amet faucibus est, at sagittis tortor. Mauris tempus leo vitae vulputate tristique. Suspendisse sem justo, consectetur malesuada nisi a, gravida dictum ex. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin et blandit ipsum. </br> Nombre Apellidos. Medio. </p>
			</blockquote>
		...
		<aside class="col-sm-4">
			<ul class="list-unstyled single-extra">
				<li id="single-extra-tickets"><a href="">Comprar entradas</a></li>
